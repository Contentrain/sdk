...
export function isValidLocale<K extends keyof ContentrainTypeMap>(modelId: K, locale: string): locale is QueryLocale<K> {
...
export function isValidModel(modelId: string): modelId is keyof ContentrainTypeMap {
  return modelId in contentrainMetadata;
}

export function isValidRelation<K extends keyof ContentrainTypeMap>(modelId: K, relation: string): relation is Extract<keyof ModelRelations[K], string> {
