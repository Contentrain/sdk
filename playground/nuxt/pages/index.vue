...
const filteredWorkItemsQuery = useContentrainQuery('workitems')
    .locale('tr')
    .get();
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="grid grid-cols-2 gap-6">
                        <div class="border p-4 rounded-lg">
                            ...
                            <div v-if="trContent">
                                <h5 class="font-medium">{{ trContent.data.title }}</h5>
                        ...
                        <div class="border p-4 rounded-lg">
                            ...
                            <div v-if="enContent">
                                <h5 class="font-medium">{{ enContent.data.title }}</h5>
