...
import { promises as promises$2, existsSync } from 'node:fs';
import { dirname as dirname$1, resolve as resolve$1, join } from 'node:path';
import { fileURLToPath } from 'node:url';
import * as promises$1 from 'fs/promises';
import * as path$2 from 'path';
import * as tinyLru$1 from 'tiny-lru';
...
const assets$1 = {
  "/favicon.ico": {
    ...
    "mtime": "2025-01-13T08:30:18.563Z",
    "size": 4286,
  ...
  "/_nuxt/CKZACw-k.js": {
    ...
    "etag": "\"24e4-Aa7vjJcomUE89dr6sJqJJPl2GwY\"",
    "mtime": "2025-01-13T08:30:18.561Z",
    "size": 9444,
    "path": "../public/_nuxt/CKZACw-k.js"
  },
  "/_nuxt/CPG78eTc.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2097e-vDHFY8Q1uF2ZcxJSi7lnpOzmz24\"",
    "mtime": "2025-01-13T08:30:18.561Z",
    "size": 133502,
    "path": "../public/_nuxt/CPG78eTc.js"
  },
  "/_nuxt/D-Y8l3p8.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"d57-2WvkuQAEY9hArn1zSJvsesyEsd0\"",
    "mtime": "2025-01-13T08:30:18.561Z",
    "size": 3415,
    "path": "../public/_nuxt/D-Y8l3p8.js"
  },
  "/_nuxt/error-404.BQeP9oU2.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"de4-4RpBWsDj8I3B8+qzP84W2bzqGQU\"",
    "mtime": "2025-01-13T08:30:18.561Z",
    "size": 3556,
    "path": "../public/_nuxt/error-404.BQeP9oU2.css"
  },
  "/_nuxt/error-500.benOP70h.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"75c-p3H/0EvbEKkNCoPhipgoRpd+ajQ\"",
    "mtime": "2025-01-13T08:30:18.561Z",
    "size": 1884,
    "path": "../public/_nuxt/error-500.benOP70h.css"
  },
  "/_nuxt/jzr9Ie2r.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1d2-lp42qv3ElDaSHMow8YiaP6Rp0rI\"",
    "mtime": "2025-01-13T08:30:18.561Z",
    "size": 466,
    "path": "../public/_nuxt/jzr9Ie2r.js"
  },
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-aKlxj/1K/gl8KadyxzfIwxPsx5M\"",
    "mtime": "2025-01-13T08:30:18.557Z",
    "size": 71,
    "path": "../public/_nuxt/builds/latest.json"
  },
  "/_nuxt/builds/meta/6b5dd3fa-104f-4ce4-9e8c-93eac18e908a.json": {
    "type": "application/json",
    "etag": "\"8b-FpQKA9EeW7qIomjSZ3d8gVZJ72A\"",
    "mtime": "2025-01-13T08:30:18.555Z",
    "size": 139,
    "path": "../public/_nuxt/builds/meta/6b5dd3fa-104f-4ce4-9e8c-93eac18e908a.json"
  }
};
...
function readAsset (id) {
  ...
  return promises$2.readFile(resolve(serverDir, assets$1[id].path))
}
...
const _lOWxoK = eventHandler((event) => {
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6b5dd3fa-104f-4ce4-9e8c-93eac18e908a",
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(promises$1);

const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(path$2);

const require$$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(tinyLru$1);

var promises = require$$0;
var path$1 = require$$1;
var tinyLru = require$$2;
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
var _MemoryCache = class _MemoryCache2 {
  constructor(options = {}) {
    this.stats = {
      hits: 0,
      misses: 0,
...
var _ContentLoader = class _ContentLoader2 {
  constructor(options) {
  ...
  getModelTTL(model) {
    var _a;
    return ((_a = this.options.modelTTL) == null ? undefined : _a[model]) || this.options.ttl || 0;
  }
  async clearCache() {
  ...
  async loadModelConfig(model) {
    try {
      const metadataPath = path$1.join(this.options.contentDir, "models", "metadata.json");
      ...
      const modelPath = path$1.join(this.options.contentDir, "models", `${model}.json`);
      ...
      throw new Error(`Failed to load model config for ${model}: ${(error == null ? undefined : error.message) || "Unknown error"}`);
    }
  }
  async loadContentFile(model, locale) {
    try {
      let contentPath;
      if (locale) {
        contentPath = path$1.join(this.options.contentDir, model, `${locale}.json`);
      } else {
        contentPath = path$1.join(this.options.contentDir, model, `${model}.json`);
      }
      ...
      throw new Error(
        `Failed to load content file for ${model}${locale ? ` (${locale})` : ""}: ${(error == null ? undefined : error.message) || "Unknown error"}`
      );
    }
  }
  async loadRelations(model) {
    try {
      ...
      return relationFields.map((field) => {
        ...
        const reference = (_c = (_b = (_a = options == null ? void 0 : options.reference) == null ? void 0 : _a.form) == null ? void 0 : _b.reference) == null ? void 0 : _c.value;
        if (!reference) {
      ...
      throw new Error(`Failed to load relations for ${model}: ${(error == null ? undefined : error.message) || "Unknown error"}`);
    }
  }
  async load(model) {
    const cacheKey = this.getCacheKey(model);
...
var _ContentrainQueryBuilder = class _ContentrainQueryBuilder2 {
...
var _QueryExecutor = class _QueryExecutor2 {
  constructor(loader) {
    this.loader = loader;
  }
...
var _ContentrainSDK = class _ContentrainSDK2 {
  constructor(options) {
...
var ContentrainSDK_1 = ContentrainSDK;

let _sdk = null;
function getSDK(config) {
  if (!_sdk) {
    _sdk = new ContentrainSDK_1({
...
const _T3XvXu = defineEventHandler(async (event) => {
  try {
...
const _lyDgIX = defineEventHandler(async (event) => {
  const config = useRuntimeConfig();
  const body = await readBody(event);
  const { model } = body;
  const sdk = getSDK(config);
...
const _lazy_KdIXtT = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _lOWxoK, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_KdIXtT, lazy: true, middleware: false, method: undefined },
  { route: '/api/contentrain/query', handler: _T3XvXu, lazy: false, middleware: false, method: undefined },
  { route: '/api/contentrain/load', handler: _lyDgIX, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KdIXtT, lazy: true, middleware: false, method: undefined }
];
...
async function writeFile(path, data, encoding) {
  ...
  return promises$2.writeFile(path, data, encoding);
}
function readFile(path, encoding) {
  return promises$2.readFile(path, encoding).catch(ignoreNotfound);
}
function unlink(path) {
  return promises$2.unlink(path).catch(ignoreNotfound);
}
function readdir(dir) {
  return promises$2.readdir(dir, { withFileTypes: true }).catch(ignoreNotfound).then((r) => r || []);
}
async function ensuredir(dir) {
  ...
  await promises$2.mkdir(dir).catch(ignoreExists);
}
...
async function rmRecursive(dir) {
  ...
  await Promise.all(
    entries.map((entry) => {
      const entryPath = resolve$1(dir, entry.name);
      if (entry.isDirectory()) {
        return rmRecursive(entryPath).then(() => promises$2.rmdir(entryPath));
      } else {
        return promises$2.unlink(entryPath);
      }
    })
  );
}
...
const unstorage_47drivers_47fs_45lite = defineDriver((opts = {}) => {
  ...
  return {
    ...
    async getMeta(key) {
      const { atime, mtime, size, birthtime, ctime } = await promises$2.stat(r(key)).catch(() => ({}));
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/ahmetbayramoglu/Desktop/Projects/contentrain-sdk/playground/nuxt/.data/kv"}));
